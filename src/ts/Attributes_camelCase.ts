...
export interface HTMLGlobalAttributes extends Omit<HTMLGlobalAttributes_core,
    | "autocapitalize"
    | "autofocus"
    | "contenteditable"
    | "enterkeyhint"
...
export interface HTMLCommonAttributes extends Omit<HTMLCommonAttributes_core,
    ...
    | "usemap"
> {
    "acceptCharset": HTMLCommonAttributes_core["accept-charset"]; // Special: "accept-charset"
    ...
    // "enterKeyHint": HTMLCommonAttributes_core["enterkeyhint"]; // Global.
    ...
    "httpEquiv": HTMLCommonAttributes_core["http-equiv"]; // Special: "http-equiv"
